  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-4 z-20 md:hidden">
        <button
          onClick={toggleMenu}
          className="btn btn-circle btn-ghost text-gray-300"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-full md:w-80 bg-gray-800 shadow-xl z-10 
                    transform transition-transform duration-300 border-r border-gray-700
                    ${
                      isOpen
                        ? "translate-x-0"
      ...
      >
        <div className="p-4">
          ...
          <ul className="menu">
            ...
            <li>
              <Link to={"/general-notes"} onClick={closeMenu}>
                <a className="flex gap-2 hover:bg-gray-700 rounded-lg text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-blue-400"
            ...
            <li>
              <Link to={"/professional-notes"} onClick={closeMenu}>
                <a className="flex gap-2 hover:bg-gray-700 rounded-lg text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-green-400"
            ...
            <li>
              <Link to={"/grocery-notes"} onClick={closeMenu}>
                <a className="flex gap-2 hover:bg-gray-700 rounded-lg text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link to={"/shopping-notes"} onClick={closeMenu}>
                <a className="flex gap-2 hover:bg-gray-700 rounded-lg text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-red-400"
            ...
            <li>
              <Link to={"/ideas-notes"} onClick={closeMenu}>
                <a className="flex gap-2 hover:bg-gray-700 rounded-lg text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-yellow-400"
            ...
            <li>
              <Link to={"/daily-notes"} onClick={closeMenu}>
                <a className="flex gap-2 hover:bg-gray-700 rounded-lg text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-blue-400"
            ...
            <li>
              <Link to={"/event-notes"} onClick={closeMenu}>
                <a className="flex gap-2 hover:bg-gray-700 rounded-lg text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link to={"/important-notes"} onClick={closeMenu}>
                <a className="flex gap-2 hover:bg-gray-700 rounded-lg text-gray-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
